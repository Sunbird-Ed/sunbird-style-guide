export const memberCardData = [
  {
    ...
    copyCSS: `       
        ...
        .sb-members-list-item .status {
          border: 1px 16px solid var(--cc-members-list-item-status-br);
