...
.sb--card.sb--card--theme2 .sb--card__meta1 .data_2:last-child {
  ...
  <div class="sb--card__main-area">
    ...
    .sb--card__type::before {
      ...
      border-width: 0.625rem 0.3125rem;
      border-style: solid;
      border-color: var(--cc-sbcard-type-br) var(--cc-sbcard-type-br)
        var(--cc-sbcard-type-br) transparent;
      position: absolute;
      left: -0.625rem;
    }
    html[dir='rtl'] .sb--card__type::before {
      right: -0.625rem;
      left: inherit;
      border-color: var(--cc-sbcard-type-br) transparent var(--cc-sbcard-type-br)
        var(--cc-sbcard-type-br);
    }
    .sb--card--recently-viewed .sb--card__img {
      height: 5.5rem;
      width: 5.5rem;
    ...
    .kabab-menu:hover .kabab-menu-dropdown-content {
      display: block;
    }
    .kabab-menu-dropdown-content .list {
      display: flex;
      align-items: center;
      cursor: pointer;
      font-size: 0.875rem;
    ...
    .kabab-menu-dropdown-content .list:hover,
    .kabab-menu-dropdown-content .list:active {
      background-color: var(--kabab-menu-dropdown-item-active);
    }
    .kabab-menu-dropdown-content .list:last-child .sb-btn-normal {
      color: var(--red-400);
    }
    .kabab-menu-dropdown-content .list .sb-btn-normal {
      font-size: 0.875rem;
    }
    ::ng-deep html[dir='rtl'] .kabab-menu-dropdown-content {
      right: auto;
      left: 0;
    }


.sb--card.sb--card--theme2.sb--card--v3 {
    border-radius: 0.5rem;
    padding: 0.5rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__main-area {
    flex-direction: row-reverse;
    align-items: flex-start;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__details {
    font-size: 0.75rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__img {
    width: 3.5rem;
    flex: 0 0 3.5rem;
    margin: 0rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__img .img-container {
    width: 3.5rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__info {
    display: flex;
    flex-direction: column;
    align-items: flex-start;
    padding-left: 0;
  }
  html[dir='rtl'] .sb--card.sb--card--theme2.sb--card--v3 .sb--card__info {
    padding-right: 0;
    padding-left: 0.5rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__info .data_3 {
    border-radius: 0.25rem;
  ...
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__info .data_4 {
    font-size: 0.9rem;
    margin: 0.125rem 0;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__title {
    color: unset;
    font-size: 1.125rem;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__meta1 {
    margin-top: 0px;
    width: 100%;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__meta1 .data_1,
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__meta1 .data_2 {
  ...
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__meta1 .data_2:last-child {
    margin-right: 0px;
  }
  .sb--card.sb--card--theme2.sb--card--v3
    .sb--card__meta1
  ...
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__image-pos {
    position: initial;
  }
  .sb--card.sb--card--theme2.sb--card--v3 .sb--card__image-pos .img-container {
    height: 4.5rem;
    border-radius: 0.5rem;
    border: 0;
  }
...
.sb--card.sb--card--theme2 {
  ...
  .sb--card.sb--card--theme2.sb--card--v4 {
    border-radius: 1.5rem;
  }
